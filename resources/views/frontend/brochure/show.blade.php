                    ...
                    <div class="wrap__date">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right break480">
                                <a href="{{ $catalogue->url }}" class="btn-download">{{ trans('button.download') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="brochure__content__item">
                            <div class="brochure__content__hover">
                                <div class="brochure__content__img">
                                    <a href="{{ route('ebrochure.show', $rs->slug) }}" style="background-image:url({{ $rs->image }})">
                            ...
                            <div class="text-center brochure__link">
                                <a href="{{ route('ebrochure.show', $rs->slug) }}"
