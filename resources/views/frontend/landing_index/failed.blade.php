...
<html lang="en">
	<head>
		...
		<link href="{{asset('landing_templates/static/thankyou/vendors/slick/slick.css')}}" rel="stylesheet">
		<link href="{{asset('landing_templates/static/thankyou/vendors/slick/slick-theme.css')}}" rel="stylesheet">
		<link href="{{asset('landing_templates/static/thankyou/css/style.min.css')}}" rel="stylesheet">
		<link href="{{asset('landing_templates/static/thankyou/css/newpage.css')}}" rel="stylesheet">
	...
	<body>
		<header class="main-header">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="logo text-left"><a href="https://easycredit.vn" target="_blank" title="EasyCredit"><img src="{{asset('landing_templates/static/thankyou/img/logo.png')}}" atl="Logo Easy Credit"></a></div>
						<ul class="block-social text-right">
							<li class="icon-social"><a href="https://www.facebook.com/EASYCREDIT.VN" target="_blank" title="Facebook"><img src="{{asset('landing_templates/static/thankyou/img/facebook-logo.png')}}" alt="Facebook"></a></li>
							<li class="icon-social"><a href="https://www.youtube.com/easycreditvn" target="_blank" title="Youtube"><img src="{{asset('landing_templates/static/thankyou/img/youtube-logo.png')}}" alt="Youtube"></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="new-modal">
            <div class="modal-body">
				...
				Số điện thoại của bạn đã tồn tại trong hệ thống
                </h5>
                <p><strong>Bạn cần hỗ trợ? </strong></p>
		...
		<footer class="footer">
			<div class="mid-footer">
				<div class="container">
					<div class="row">
						<div class="col-sm-5">
							<div class="logo text-center"><img src="{{asset('landing_templates/static/thankyou/img/logo-big.png')}}" alt="Logo"></div>
						</div>
						<div class="col-sm-7">
							<div class="desc"><span><img src="{{asset('landing_templates/static/thankyou/img/A.png')}}" alt="Địa điểm"></span><span>  610 Võ Văn Kiệt, P. Cầu Kho, Quận 1, TP.Hồ Chí Minh</span></div>
							<div class="desc"><span><img src="{{asset('landing_templates/static/thankyou/img/E.png')}}" alt="Email"></span><span>  info@easycredit.vn</span></div>
						</div>
					</div>
				</div>
			</div>
