...
<head>
    ...
    <title>E-link | {{ config('app.name') }}</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
@yield("meta")

    <!-- Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="/assets/elink/images/favicon.ico">
    ...
    <link href="/assets/elink/css/app.css" rel="stylesheet"/>

    @include("elink.layouts.partials.define")
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">E-LINK - {{ config('app.name') }}</a>
        </div>
    </div>
</nav>

@include("elink.layouts.partials.menu")
...
<script src="/assets/elink/js/app.js?v=1521165460"></script>
