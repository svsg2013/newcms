...
@section("meta")
    <meta name="linkSort" content="{{ route('admin.product_category.sort') }}"/>
@endsection
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/product_category.index.js?v=1.1"></script>
@endsection