...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.city.career.datatable') }}"/>
@endsection
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.city.career.create") !!}" class="btn btn-info waves-effect pull-right">
                    <i class="material-icons">add</i>
                    <span>{!! trans("button.create") !!}</span>
                </a>
                <h2>
                    {!! trans("admin_city.list") !!}
                </h2>
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    <thead>
                    <tr>
                        <th width="40">{!! trans("admin_city.table.id") !!}</th>
                        <th>{!! trans("admin_city.table.name") !!}</th>
                        <th>{!! trans("admin_city.table.active") !!}</th>
                        <th width="150">{!! trans("admin_city.table.action") !!}</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/city_career.index.js?v=1.0"></script>
@endsection