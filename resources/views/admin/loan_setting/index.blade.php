...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.loan.setting.datatable') }}"/>
@endsection
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.loan.setting.create") !!}" class="btn btn-info waves-effect pull-right">
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/loan_setting.index.js?v=1.0"></script>
@endsection