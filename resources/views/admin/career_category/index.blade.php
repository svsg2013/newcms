...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.career_category.datatable') }}"/>
@endsection
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.career_category.create") !!}" class="btn btn-info waves-effect pull-right">
                    <i class="material-icons">add</i>
                    <span>{!! trans("button.create") !!}</span>
                </a>
                <h2>
                    {!! trans("admin_career_category.list") !!}
                </h2>
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    <thead>
                    <tr>
                        <th width="40">{!! trans("admin_career_category.table.id") !!}</th>
                        <th>{!! trans("admin_career_category.table.name") !!}</th>
                        <th width="150">{!! trans("admin_career_category.table.action") !!}</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/career_category.index.js?v=1.0"></script>
@endsection