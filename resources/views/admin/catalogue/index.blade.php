...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.catalogue.datatable') }}"/>
@endsection
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.catalogue.create") !!}" class="btn btn-info waves-effect pull-right">
                    <i class="material-icons">add</i>
                    <span>{!! trans("button.create") !!}</span>
                </a>
                <h2>
                    {!! trans("admin_catalogue.list") !!}
                </h2>
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th>{!! trans("admin_catalogue.table.name") !!}</th>
                        <th>{!! trans("admin_catalogue.table.type") !!}</th>
                        <th>{!! trans("admin_catalogue.table.publish_date") !!}</th>
                        <th width="150">{!! trans("admin_catalogue.table.action") !!}</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/catalogue.index.js?v=1.0"></script>
@endsection