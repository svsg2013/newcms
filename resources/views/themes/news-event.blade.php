...
@if(!empty($blocks['NEWS-BANNER'][0]))
<section class="breadcrumbs breadcrumbs--blue" style="background-image: url({!! $blocks['NEWS-BANNER'][0]->photo !!})" data-paroller-factor="0.4"
    data-paroller-factor-xs="0.2" data-paroller-factor-sm="0.3">
    <div class="container text-center">
        <h1>{!! $blocks['NEWS-BANNER'][0]->name !!}</h1>
...
<section class="boxquote">
    <div class="container text-center">
        <h2 class="boxquote_head">{!! !empty($blocks['NEWS-GENERAL'][0]) ? $blocks['NEWS-GENERAL'][0]->name : '' !!}</h2>
        <div class="boxquote_content">
            {!! !empty($blocks['NEWS-GENERAL'][0]) ? $blocks['NEWS-GENERAL'][0]->description : '' !!}
        </div>
    </div>
</section>
<section class="promotionPage" id="link-promotionPage">
    <div class="container">
        <div class="promotionIntro">
            <div class="promotionIntro__image" data-animated-effect="fadeInLeft">
                <div class="image imageEffect">
                    <a style="background-image:url('{!! !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->photo : '' !!}')" href="#">
                        <img src="{!! !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->photo : '' !!}" alt="">
                    </a>
                </div>
            </div>
            <div class="promotionIntro__info">
                <div class="promotionIntro__content" data-animated-effect="fadeInUp" data-animated-delay="200">
                    <a href="{!! !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->url : '' !!}">{!! !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->name : '' !!}</a>
                    {!! !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->content : '' !!}
                </div>
                <div class="promotionIntro__video" data-animated-effect="fadeInUp" data-animated-delay="200">
                    <div class="text-center">
                        <a class="btn btn-danger btn-shadow btn-lg btn-shadowjs" href="{!! !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->url : '' !!}"><span class="text">xem chi tiết</span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="gridGroup__wrap" data-animated-effect="fadeInUp" data-animated-delay="{{ $key*150 }}">
                    <div class="gridGroup__item">
                        <div class="gridGroup__item__image">
                            <div class="image imageEffect">
                                <a style="background-image:url('{{ $new->image }}')" href="{{ route('frontend.news.show', $new->slug) }}">
                        ...
                        <div class="gridGroup__item__info">
                            <h4>
                                <a href="{{ route('frontend.news.show', $new->slug) }}">{{ $new->title }}</a>
                            </h4>
                            <p>{{ words($new->description, 30, '...') }}</p>
                            <div class="gridGroup__item__link">
                                <a class="read-more" href="{{ route('frontend.news.show', $new->slug) }}">
                ...
                <div class="gridGroup__wrap" data-animated-effect="fadeInUp" data-animated-delay="{{ $key*150 }}">
                    <div class="gridGroup__item">
                        <div class="gridGroup__item__image">
                            ...
                            <a class="playVideo" href="javascript:void(0)" id="play01"></a>
                            <iframe class="videoInner" id="video01" width="100%" height="100%" src="https://www.youtube.com/embed/{{ !empty($video[1][0]) ? trim($video[1][0]) : '' }}?enablejsapi=1&showinfo=0&rel=0"
        ...
        <div class="promotionLink">
            ...
            <span data-animated-effect="fadeInRight">
                {!! $blocks['NEWS-SIGN-UP'][0]->name !!}
            </span>
        </div>
    </div>
</section>

@if(!empty($blocks['NEWS-FOOTER'][0]))
<section class="getStarted" style="background-image: url('{!! $blocks['NEWS-FOOTER'][0]->photo !!}')" data-waypoint="70%" data-paroller-factor="0.4"
    data-paroller-factor-xs="0.2" data-paroller-factor-sm="0.3">
    <div class="container">
        <h2 class="heading heading--white">{!! $blocks['NEWS-FOOTER'][0]->name !!}</h2>
        <div class="text-center">
            <a class="btn btn-danger btn-shadow btn-lg" href="{!! $blocks['NEWS-FOOTER'][0]->url !!}">nhận khoản vay</a>
        </div>
    </div>
</section>
@endif
...
<div class="modal fade peoplePopupInner" id="videoPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            @php
                preg_match('/(?:.*\/v\/|.*v\=|\.be\/)([A-Za-z0-9_\-]{11})/', !empty($blocks['NEWS-GENERAL-DETAIL'][0]) ? $blocks['NEWS-GENERAL-DETAIL'][0]->url : '', $matches, PREG_OFFSET_CAPTURE, 0);
            @endphp
...
@section('script')
    <script type="text/javascript">
        $("#link-promotionPage").ready(function(){
            $("html, body").animate({
                scrollTop: $('#link-promotionPage').offset().top - 100
            }, 2000);
        });
    </script>
@endsection