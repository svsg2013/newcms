...
return [
    ...
    'form' => [
        ...
        'email_subcribe' => 'Email subcribe (The email will receive subcribe)',
        'email' => 'Email',
        'location' => 'Location',
        'phone' => 'Phone top',
        'phone_faq' => 'Phone FAQ',
        ...
        'cookie_policy' => 'Cookie Policy Alert',
        'cookie_policy_page' => 'Cookie Policy Page',
        'cookie_policy_content' => 'Cookie Policy Content (Place text between block [policy_url][/policy_url] to put Cookie Policy page link',
    ],
