...
class LoanCalculatorController extends Controller
{
    ...
    {
        $grid = new Grid(new LoanCalculator);
        $grid->id('ID');
		...
		$grid->setResource(admin_url('loancalculator'));
    ...
    {
        $show = new Show(LoanCalculator::findOrFail($id));
        $show->id('ID');
    ...
    {
        $form = new Form(new LoanCalculator);
		$form->text('fullname');
