	...
	<head>
		...
		<script>
			var AT = {
				...
				aff_sid_param: "chin_aff_sid",
				is_reoccur: 1,
			
				init: function (options) {
					this.cookie_duration = options['cookie_duration'] ? options['cookie_duration'] : 30;
					this.aff_sid_param = options['aff_sid_param'] ? options['aff_sid_param'] : "chin_aff_sid";
				...
				track: function () {
					...
					if (sid) {
						this.set_cookie("_chin_aff_sid", sid, this.cookie_duration);
					}
				},
			...
			<div class="form">
				<div class="container">
					<div class="offset-lg-2 col-lg-8 offset-xl-6 col-xl-6 form-box">
						...
						@endif
						<form action="{{route('actionversionthree')}}" method="POST" class="parsley-validate" id="registerForm" data-validate="parsley">
			...
			$(function() {
				...
				$(document).ready(function() {
					$("#registerForm").on('submit', function(e){
						...
						var aff_sid = '';
						if (typeof AT.get_cookie("_chin_aff_sid") !== "undefined") {
							aff_sid = AT.get_cookie("_chin_aff_sid");
						}
						console.log(aff_sid);
