	...
	<head>
		...
		<script>
			var AT = {
				...
				aff_sid_param: "chin2_aff_sid",
				is_reoccur: 1,
			
				init: function (options) {
					this.cookie_duration = options['cookie_duration'] ? options['cookie_duration'] : 30;
					this.aff_sid_param = options['aff_sid_param'] ? options['aff_sid_param'] : "chin2_aff_sid";
				...
				track: function () {
					...
					if (sid) {
						this.set_cookie("_chin2_aff_sid", sid, this.cookie_duration);
					}
				},
			...
			<div class="form">
				<div class="container">
					<div class="offset-lg-2 col-lg-8 offset-xl-6 col-xl-6 form-box">
						...
						@endif
						<form action="{{route('actionversionfour')}}" method="POST" class="parsley-validate" id="registerForm" data-validate="parsley">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input class="form-control" id="inputName" name="fullname" type="text" required data-parsley-required-message="Vui lòng nhập họ và tên" data-parsley-pattern="(^[A-Za-z\u0080-þĀ-žƀ-ɎḀ-ỾⱠ-\u2c7e꜠-ꟾ' ]+$)" data-parsley-pattern-message="Vui lòng nhập họ và tên đúng định dạng" data-parsley-maxlength="50" data-parsley-maxlength-message="Vui lòng nhập họ và tên ít hơn 50 ký tự">
									...
									<div class="col-md-6">
										<div class="form-groups">
											...
											<input class="form-controls" id="inputBirth" name="birthday" onfocus="(this.type='date')" type="text" placeholder="Ngày - Tháng - Năm">
			...
			$(function() {
				...
				$(document).ready(function() {
					$("#registerForm").on('submit', function(e){
						...
						var aff_sid = '';
						if (typeof AT.get_cookie("_chin2_aff_sid") !== "undefined") {
							aff_sid = AT.get_cookie("_chin2_aff_sid");
						}
						console.log(aff_sid);
