...
use App\Validators\AchievementsValidator;

/**
 * Class AchievementsRepositoryEloquent
 *
 * @package namespace App\Repositories;
 */
class AchievementsRepositoryEloquent extends BaseRepository implements AchievementsRepository
{
    /**
    ...
    {
        return AchievementsValidator::class;
    }
    ...
    public function topAchievements($limit = 0, $is_top = false)
    {
